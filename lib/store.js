...
const Store = (() => {
    ...
    const DEFAULT_LLM_CONFIG = {
        ...
        maxTokens: 2000,
        visionMode: 'auto',
        // Reasoning model policy. 'auto' turns thinking OFF for known
        // reasoning models (DeepSeek V4, Kimi K3) so they don't burn the
        // whole max_tokens budget on chain-of-thought and return empty.
        // Users who want the visible chain-of-thought can set this to 'on'.
        reasoning: 'auto',
    };
