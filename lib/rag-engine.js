...
const RAGEngine = (() => {
    ...
    async function retrieve(query, sessionName, snippets, options = {}) {
        ...
        const result = await bm25Retrieve(query, sessionName, tokenBudget, topK);

        // Phase 1.1: HYBRID mode will add vector retrieval + RRF here
        ...
        return {
            ...
            totalCount: snippets.length,
            returnedCount: result.snippets.length
        };
    }
